...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Find winpercent value of Snickers}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Find winpercent value of Kit Kat}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Calculate winpercent value of Tootsie Roll Snack Bars}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#View how many 0s and 1s chocolate has}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Plot histogram of winpercent values}
...
\includegraphics{10_files/figure-latex/unnamed-chunk-11-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Find center of distribution}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Find average of chocolate candy ranking}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Find average of fruity candy ranking}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Perform t{-}test of chocolate and fruity candy}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Order candy types by least popular where n = 5}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Order candy types by most popular where n = 5}
...
\includegraphics{10_files/figure-latex/unnamed-chunk-17-1.pdf} Q16. This
...
\includegraphics{10_files/figure-latex/unnamed-chunk-18-1.pdf}

Sorted with color:

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Plot using colors}
...
\includegraphics{10_files/figure-latex/unnamed-chunk-19-1.pdf}
...
\includegraphics{10_files/figure-latex/unnamed-chunk-20-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Order candy by price and popularity}
...
\FunctionTok{head}\NormalTok{( candy[ord,}\FunctionTok{c}\NormalTok{(}\DecValTok{12}\NormalTok{,}\DecValTok{13}\NormalTok{)], }\AttributeTok{n=}\DecValTok{5}\NormalTok{ )}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{10_files/figure-latex/unnamed-chunk-22-1.pdf}
...
\includegraphics{10_files/figure-latex/unnamed-chunk-23-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(pca}\SpecialCharTok{$}\NormalTok{x[, }\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{)])}
\end{Highlighting}
\end{Shaded}

\includegraphics{10_files/figure-latex/unnamed-chunk-25-1.pdf}
...
\includegraphics{10_files/figure-latex/unnamed-chunk-26-1.pdf}
...
\includegraphics{10_files/figure-latex/unnamed-chunk-28-1.pdf}
...
\includegraphics{10_files/figure-latex/unnamed-chunk-29-1.pdf}
...
\includegraphics{10_files/figure-latex/unnamed-chunk-31-1.pdf}
...
\includegraphics{10_files/figure-latex/unnamed-chunk-32-1.pdf}
